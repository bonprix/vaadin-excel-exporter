 ...
 * formatting, headers, footers, styles etc. can also be configured
 *
 * @author Kartik Suba
 */
@GeneratePojoBuilder(
...
public class ExportExcelComponentConfiguration {
     ...
     *
     * @param colRowFreeze the new col row freeze
     */
     ...
     * Sets the tree table.
     *
     * @param treeTable the new tree table
     */
     ...
     *
     * @param tableFooterStyle the new table footer style
     */
     ...
     *
     * @param rTableFooterStyle the new resultant table footer style
     */
     ...
     *
     * @param rTableHeaderStyle the new resultant table header style
     */
     ...
     *
     * @param rTableContentStyle the new resultant table content style
     */
     ...
     *
     * @param headerConfigs the new header configs
     */
     ...
     *
     * @param footerConfigs the new footer configs
     */
     ...
     *
     * @param visibleProperties the new visible properties
     */
     ...
     *
     * @param tableHeaderStyle the new table header style
     */
     ...
     *
     * @param tableContentStyle the new table content style
     */
