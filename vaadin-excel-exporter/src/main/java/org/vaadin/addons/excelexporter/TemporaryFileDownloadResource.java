...
public class TemporaryFileDownloadResource extends StreamResource {
     ...
     */
    public TemporaryFileDownloadResource(final UI application, final String fileName, final String contentType, final File tempFile)
    ...
    public DownloadStream getStream() {
        final DownloadStream stream = new DownloadStream(getStreamSource().getStream(), this.contentType, this.filename);
